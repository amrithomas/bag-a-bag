...
$query_consulta = "SELECT * FROM aeroporto WHERE ID_AEROPORTO = '$id'";
...
if (mysqli_num_rows($consulta) == 1) {
    ...
    $_SESSION["msg"] = "<p class='text-center' style='color: red;'>Erro ao encontrar aeroporto para edição</p>";
    unset($_SESSION);
...
<body>
    ...
    <main class="container" style="margin-top: 15em;">
        <div class="card">
            ...
            <form action="../controller/controller_editar_aeroporto.php" method="POST">

                <div class="card-body">
                    <input type="hidden" name="id" value="<?php echo $row_consulta['ID_AEROPORTO'] ?>">

                    <label for="sigla">Sigla:</label>
                    <input type="text" id="sigla" value="<?php echo $row_consulta['SIGLA'] ?>" name="sigla" required><br>

                    <label for="nome_aeroporto">Nome do Aeroporto:</label>
                    <input type="text" id="nome_aeroporto" value="<?php echo $row_consulta['NOME_AEROPORTO'] ?>" name="nome_aeroporto" required><br>

                    <label for="pais">País:</label>
                    <input type="text" id="pais" value="<?php echo $row_consulta['PAIS']?>" name="pais" required><br>

                    <label for="cidade">Cidade:</label>
                    <input type="text" id="cidade" value="<?php echo $row_consulta['CIDADE'] ?>" name="cidade" required><br>
                </div>
